...
public class SparkFunOTOSDrive extends MecanumDrive {
    ...
    private static Pose2d OTOSPoseToRRPose(SparkFunOTOS.Pose2D otosPose) {
        return new Pose2d(
                new Vector2d(otosPose.x, otosPose.y),
                Rotation2d.fromDouble(Math.toRadians(otosPose.h)));
    }

    private static SparkFunOTOS.Pose2D RRPoseToOTOSPose(Pose2d pose) {
