...
public class Wrist {
    ...
    // Down position
    public static double DOWN_POSITION = 0.16;

    public static double HIGH_CHAMBER_HOLD_POSITION = 0.69;
    public static double HIGH_CHAMBER_CLIP_POSITION = 0.9;
    ...
    // Init position
    public static double INITIALIZE_POSITION = 0.84;
