...
public class ColorBlobLocatorProcessorImplTwo extends ColorBlobLocatorProcessorTwo implements VisionProcessor
{
    ...
    ColorBlobLocatorProcessorImplTwo(ColorRangeTwo colorRange, ImageRegionTwo roiImg, ColorBlobLocatorProcessorTwo.ContourMode contourMode,
    ...
    public Object processFrame(Mat frame, long captureTimeNanos)
    {
        ...
        for (MatOfPoint contour : contours)
        {
            ...
            blobs.add(new ColorBlobLocatorProcessorImplTwo.BlobImpl(contour));
        }
